...
Interpreter.prototype.initGlobalScope = function(scope) {
  ...
  this.setProperty(scope, 'undefined',
                   this.UNDEFINED, true);
  this.setProperty(scope, 'global', // 'window',
                   scope, true);
...
exports.BuildInterpreter = function (code, opt) {
	return new Interpreter(code, opt);
}
